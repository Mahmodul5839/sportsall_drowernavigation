...
public class Watch8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(Watch8.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(Watch8.this);
        ...
        webView.setWebViewClient(new Watch8.HelloWebViewClient());
        webView.setWebChromeClient(new Watch8.ChromeClient());
        ...
        webView.loadUrl("http://tv.hotflix.stream/live-tv/star-sports-3.html");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Watch8.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Watch8.this)){
