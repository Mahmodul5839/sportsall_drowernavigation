...
public class Score4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(Score4.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(Score4.this);
        ...
        webView.setWebViewClient(new Score4.HelloWebViewClient());
        webView.setWebChromeClient(new Score4.ChromeClient());
        ...
        webView.loadUrl("https://sports.ndtv.com/cricket/live-scores");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Score4.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Score4.this)){
