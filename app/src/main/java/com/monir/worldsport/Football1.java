...
public class Football1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(Football1.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(Football1.this);
        ...
        webView.setWebViewClient(new Football1.HelloWebViewClient());
        webView.setWebChromeClient(new Football1.ChromeClient());
        ...
        webView.getSettings().setMediaPlaybackRequiresUserGesture(false);//impotant..................................
        ...
        webView.loadUrl("http://tv.hotflix.stream/live-tv/la-liga.html");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Football1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Football1.this)){
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartAppAd.showAd(Football1.this);
                finish();
            }
        });
