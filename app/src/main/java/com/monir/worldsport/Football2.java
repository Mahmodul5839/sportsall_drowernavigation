...
public class Football2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(Football2.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(Football2.this);
        ...
        webView.setWebViewClient(new Football2.HelloWebViewClient());
        webView.setWebChromeClient(new Football2.ChromeClient());
        ...
        webView.loadUrl("http://tv.hotflix.stream/live-tv/premier-league-live.html");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Football2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Football2.this)){
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartAppAd.showAd(Football2.this);
                finish();
            }
        });
