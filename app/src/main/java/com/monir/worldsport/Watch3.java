...
public class Watch3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animation = android.view.animation.AnimationUtils.loadAnimation(Watch3.this, R.anim.middle_to_top);


        //Creating webView programitcally which supports media player and js automatically like a browser
        webView = new WebView(Watch3.this);
        ...
        webView.setWebViewClient(new Watch3.HelloWebViewClient());
        webView.setWebChromeClient(new Watch3.ChromeClient());
        ...
        webView.loadUrl("http://tv.hotflix.stream/live-tv/sony-ten-1.html?key=tffz3pms9olr");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Watch3.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Watch3.this)){
