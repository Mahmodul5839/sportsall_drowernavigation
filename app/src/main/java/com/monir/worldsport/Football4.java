...
public class Football4 extends AppCompatActivity {

    WebView webView;
    LinearLayout layNonet;
    LottieAnimationView progressBar;
    LinearLayout layRoot , layRoott;
    ImageView imgBack;
    Animation animation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new Football4.HelloWebViewClient());
        webView.setWebChromeClient(new Football4.ChromeClient());
        ...
        //zoom controls done***********************************O*O***********

        webView.getSettings().setCacheMode(WebSettings.LOAD_NO_CACHE);

        webView.loadUrl("http://tv.hotflix.stream/live-tv/supersport-football.html");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Football4.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Football4.this)){
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StartAppAd.showAd(Football4.this);
                finish();
            }
        });
