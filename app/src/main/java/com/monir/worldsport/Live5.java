...
public class Live5 extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new Live5.HelloWebViewClient());
        webView.setWebChromeClient(new Live5.ChromeClient());
        ...
        webView.loadUrl("http://tv.hotflix.stream/live-tv/ptv-sports.html");
            ...
            public void onDownloadStart(final String url, final String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(Live5.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
        ...
        if(!isNetworkAvailable(Live5.this)){
